...
Sphere::Sphere(GLdouble Radius, std::string name, std::string message) :GameObjectNode(name, message), m_radius(Radius), Slices(64), Stacks(64)
{
}
...
void Sphere::Render()
{
	...
	glutSolidSphere(m_radius, Slices, Stacks);
}
